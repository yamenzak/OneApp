...
A top bar, a bottom bar, an account menu, a theme control and the usage meter.
...
<template>
  <div data-slot="empty-state" class="grid place-items-center px-6 py-16 text-center">
    <div class="max-w-sm">
      ...
      <p v-if="description" class="mt-1.5 text-p-base text-ink-secondary">
        {{ description }}
      </p>
...
import { __ } from '@/lib/runtime/translate'
import { sizeText } from '@/lib/files/size'
