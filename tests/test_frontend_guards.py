...
@pytest.mark.parametrize(
	"filename",
	["src/ui.js", "src/lib/resource.js", "src/lib/notify.js",
	 "src/lib/errors.js", "src/lib/socket.js", "src/lib/sound.js"],
)
...
def test_the_runtime_itself_is_exempt_from_that_rule(generated):
	...
	for app, files in generated.items():
		assert "src/lib/**" in files["eslint.config.js"], app
...
def test_raw_form_elements_are_banned(generated, element):
	...
	for app, files in generated.items():
		assert f"'{element}'" in files["eslint.config.js"], f"{app}: {element}"
...
def test_each_app_serves_its_own_route(generated):
	...
	for app, route in routes.items():
		assert f"frontendRoute: '{route}'" in generated[app]["vite.config.js"]
...
def test_vite_config_uses_the_frappe_ui_plugin(generated):
	...
	for app, files in generated.items():
		assert "frappe-ui/vite" in files["vite.config.js"], app
...
def test_tailwind_lists_frappe_ui_content(generated):
	...
	for app, files in generated.items():
		assert "frappeUIContent" in files["tailwind.config.js"], app
