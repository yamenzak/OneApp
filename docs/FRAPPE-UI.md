...
| SettingsDialog | **Not responsive**: fixed `px-[4.4rem]`, and Dialog's chrome clips a `w-screen` panel | Scoped `index.css` correction below `sm` | `test_settings_dialog_geometry.py` pins each upstream value |
