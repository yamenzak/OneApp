...
| `lib/rowstate.js` | The five states a row can be in, as one set of classes: hover, focus, selected, open and dragged. Generated, and the reason a hovered file and a selected file are no longer the same colour. |
